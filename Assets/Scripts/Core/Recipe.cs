...
public class Recipe
{
    ...
    public void UpdateProduction(float deltaTime)
    {
        ...
        if (_building.Name == "Furnace") speedModifier += Stats.Instance.Researches.FurnaceEfficiency.GetValue();
        if (_building.Name == "Forge") speedModifier += Stats.Instance.Researches.ForgeEfficiency.GetValue();
        if (_building.Name == "Factory") speedModifier += Stats.Instance.Researches.FactoryEfficiency.GetValue();
        _timeInProduction += deltaTime * speedModifier;
